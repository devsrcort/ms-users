...
actions.sendTokenByClient = async function (req, res, next) {
  ...
  try {
    await tokenSender.sendToken(API_BASE, fromAddr, toAddr, amount, fee, users[0]['balance']);
